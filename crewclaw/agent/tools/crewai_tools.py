...
class WebSearchTool(BaseTool):
    ...
    def _run(self, query: str, count: int = 5) -> str:
        ...
        import asyncio
        from crewclaw.agent.tools.web import WebSearchTool as RawWebSearchTool
...
class WebFetchTool(BaseTool):
    ...
    def _run(self, url: str, extract_mode: str = "markdown", max_chars: int = 50000) -> str:
        ...
        import asyncio
        from crewclaw.agent.tools.web import WebFetchTool as RawWebFetchTool
...
class FileReadToolCrewAI(BaseTool):
    ...
    def _run(self, path: str, offset: int = 1, limit: int | None = None) -> str:
        ...
        import asyncio
        from crewclaw.agent.tools.file_read import FileReadTool as RawFileReadTool
...
class FileWriteToolCrewAI(BaseTool):
    ...
    def _run(self, path: str, content: str, append: bool = False) -> str:
        ...
        import asyncio
        from crewclaw.agent.tools.file_write import FileWriteTool as RawFileWriteTool
...
class GrepToolCrewAI(BaseTool):
    ...
    def _run(
        ...
        """Execute the grep."""
        import asyncio
        from crewclaw.agent.tools.grep import GrepTool as RawGrepTool
...
class DirectoryListToolCrewAI(BaseTool):
    ...
    def _run(self, path: str = ".", recursive: bool = False, max_depth: int = 3) -> str:
        ...
        import asyncio
        from crewclaw.agent.tools.directory_list import DirectoryListTool as RawDirectoryListTool
...
class MemorySearchToolCrewAI(BaseTool):
    ...
    def _run(self, query: str, limit: int = 5, collection: str = "default") -> str:
        ...
        import asyncio
        from crewclaw.agent.tools.memory_search import MemorySearchTool as RawMemorySearchTool
...
class ExecToolCrewAI(BaseTool):
    ...
    def _run(self, command: str, working_dir: str | None = None) -> str:
        ...
        import asyncio
        from crewclaw.agent.tools.shell import ExecTool as RawExecTool
